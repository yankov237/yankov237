...
class ContTorqueControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a abc-domain continuous control set torque controlled doubly fed induction motor.
