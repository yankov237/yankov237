...
class FiniteTorqueControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a finite control set torque controlled doubly fed induction motor.
