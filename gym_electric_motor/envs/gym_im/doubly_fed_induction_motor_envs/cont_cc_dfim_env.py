...
from gym_electric_motor.physical_systems.scml_system import DoublyFedInductionMotorSystem
...
class ContCurrentControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a abc-domain continuous control set current controlled doubly fed induction motor.
