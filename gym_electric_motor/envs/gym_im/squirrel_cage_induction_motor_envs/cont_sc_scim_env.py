...
from gym_electric_motor.physical_systems.scml_system import SquirrelCageInductionMotorSystem
...
class ContSpeedControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
    ...
    def __init__(self, supply=None, converter=None, motor=None, load=None, ode_solver=None,
                 ...
                 physical_system_wrappers=(), constraints=(SquaredConstraint(('i_sq', 'i_sd')),),
