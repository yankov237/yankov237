...
from gym_electric_motor.physical_systems.scml_system import SynchronousMotorSystem
...
class FiniteSpeedControlPermanentMagnetSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
