...
from gym_electric_motor.physical_systems.scml_system import ExternallyExcitedSynchronousMotorSystem, SynchronousMotorSystem
...
class ContTorqueControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
