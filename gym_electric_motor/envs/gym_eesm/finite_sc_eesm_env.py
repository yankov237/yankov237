...
class FiniteSpeedControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a finite control set speed controlled externally excited synchronous motor.
    ...
    Default Components:
        ...
        - Visualization: :py:class:`.MotorDashboard` speed and action plots
    ...
    def __init__(self, supply=None, converter=None, motor=None, load=None, ode_solver=None,
        ...
        reward_function = initialize(
            RewardFunction, reward_function, WeightedSumOfErrors, dict(reward_weights=dict(omega=1))
        )
