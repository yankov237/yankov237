...
class ContCurrentControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a continuous control set current controlled externally excited synchronous motor.
    ...
    def __init__(self, supply=None, converter=None, motor=None, load=None, ode_solver=None,
                 ...
                 constraints=(SquaredConstraint(('i_sq', 'i_sd')), LimitConstraint(('i_e',))), calc_jacobian=True, tau=1e-4):
        """
        Args:
        ...
        default_subgenerators = (
            ...
            WienerProcessReferenceGenerator(reference_state='i_e', limit_margin=(0, 1)),
        )
