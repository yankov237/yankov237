...
from gym_electric_motor.physical_systems.scml_system import ExternallyExcitedSynchronousMotorSystem
...
class FiniteTorqueControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a finite control set torque controlled externally excited synchronous motor.
    ...
    Default Components:
        ...
        - Reference Generator: :py:class:`.WienerProcessReferenceGenerator` *Reference Quantities:* ``'torque'``
    ...
    def __init__(self, supply=None, converter=None, motor=None, load=None, ode_solver=None,
        ...
        reward_function = initialize(
            RewardFunction, reward_function, WeightedSumOfErrors, dict(reward_weights=dict(torque=1))
        )
