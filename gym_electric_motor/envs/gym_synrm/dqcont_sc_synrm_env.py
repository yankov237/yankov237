...
class DqContSpeedControlSynchronousReluctanceMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a dq-domain continuous control set speed controlled synchronous reluctance motor.
