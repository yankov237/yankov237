...
class FiniteCurrentControlDcExternallyExcitedMotorEnv(ElectricMotorEnvironment):
    ...
    Default Components:
        ...
        - Converter: :py:class:`.FiniteMultiConverter` ( 2 x :py:class:`.FiniteFourQuadrantConverter`)
        - Motor: :py:class:`.DcExternallyExcitedMotor`
        - Load: :py:class:`.ConstantSpeedLoad`
        - Ode-Solver: :py:class:`.EulerSolver`

        - Reference Generator: :py:class:`.WienerProcessReferenceGenerator` *Reference Quantity:* ``'i_a', 'i_e'``

        - Reward Function: :py:class:`.WeightedSumOfErrors` reward_weights: ``'i_a' = 0.5, 'i_e' = 0.5``
    ...
    def __init__(self, supply=None, converter=None, motor=None, load=None, ode_solver=None,
        ...
        visualization = initialize(
            ...
            dict(state_plots=('i_a', 'i_e',), action_plots='all'))
        super().__init__(
